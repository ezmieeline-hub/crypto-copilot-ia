...
for router in (health_router,auth_router,analysis_router,extras_router,journal_router,dashboard_router,compare_router): app.include_router(router,prefix="/api")
